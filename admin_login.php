...
$conn = oci_connect('TEAMUNITED', 'United@123', 'localhost/XE');
	...
	if(isset($_POST['login'])){
			    ...
			    $password=$_POST['password'];
			           $s = oci_parse($conn, "select * from ADMIN_TABLE where ADMIN_USERNAME='$user' and ADMIN_PASSWORD='$password'");
			            oci_execute($s);
...
<body>
	<div class="container">
		...
		<div class="right">
			...
			<div style="text-align: center; float: left;"><h4>Go to <a href="login.php">Customer's Login</a> or <a href="trader_login.php">Trader's Login</a></h4></div>
		</div>
	</div>
</body>
