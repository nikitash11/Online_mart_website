...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-7">
      ...
      <ul id="right-nav">
        <li><a href="#"><form method="post" ><input id="btnn" type="submit" name="logout" value="Logout"></form></a></li>
    ...
    <div class="col-2">
      ...
      <div style="width: 80%; float: right;">
        <a href=""><i class="material-icons" id="acc" style="font-size:70px; float: left; margin-left: 35px;">account_circle</i></a></p></div>
      </div>
